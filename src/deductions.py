...
def get_conversational_chain():
    prompt_template = """
    You are a helpful Tax Assistant who tells the user what all tax deductions they are eligible for based on multiple contexts given to you.
   the user data would be given in the form of a json object. Suggest the relavent sections that they can apply under.
...
def get_applicable_deductions(user_data):
...
if __name__ == "__main__":
    ...
    print(get_applicable_deductions(user_data))
